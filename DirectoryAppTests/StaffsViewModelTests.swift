...
class StaffsViewModelTests: XCTestCase {
    ...
    func testgetStaffDetails() {
        ...
        XCTAssertEqual(staffDetails.firstName, "", "Staff first Name not matching")
        XCTAssertEqual(staffDetails.lastName, "", "Staff last name not matching")
        XCTAssertEqual(staffDetails.email, "", "Staff email address not matching")
        XCTAssertEqual(staffDetails.jobtitle, "", "Staff job title not matching")
        XCTAssertEqual(staffDetails.favouriteColor, "", "Staff favourite color not matching")
        XCTAssertEqual(staffDetails.staffID, "", "Staff id not matching")
    }
}
